...
TEMP =  os.path.join(os.environ['PLENS'], 'noNoise_ideal_delensed_polQEST')
...
qresp_dd = qresp.resp_lib_simple(os.path.join(TEMP, 'qresp_delensed'), lmax_ivf, cl_weight, cl_len,
